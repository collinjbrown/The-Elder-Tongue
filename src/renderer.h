...
public:
    ...
    void prepareQuad(glm::vec2 topRight, glm::vec2 bottomRight, glm::vec2 bottomLeft, glm::vec2 topLeft, float z, glm::vec4 rgb, float scaleX, float scaleY, int textureID, int mapID);
